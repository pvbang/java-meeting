...
public class MessagePanel extends JPanel {
	...
	public MessagePanel(MessageData data) {
		...
		if (data.type.equals("notify")) {
			...
			JTextArea textContent = new JTextArea(data.content);
			textContent.setFont(new Font("Dialog", Font.PLAIN, 13));
			textContent.setEditable(false);
			...
			fileNameLabel.setFont(new Font("Dialog", Font.PLAIN, 13));
			...
			JLabel audioIcon = new JLabel(new ImageIcon(s+"\\resources\\audio.png", "audio"));
			...
			durationLabel.setFont(new Font("Dialog", Font.PLAIN, 13));
